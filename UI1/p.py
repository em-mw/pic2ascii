...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBoxFinnishOpts.addItem("")
        self.comboBoxFinnishOpts.addItem("")
        self.label_4 = QtWidgets.QLabel(self.tabJobs)
        self.label_4.setGeometry(QtCore.QRect(35, 55, 506, 141))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Look in Terminal"))
    ...
    def vars(self, MainWindow):
        print(self.comboBoxFormatOut.currentText())
